package com.example.bankingapp1.DB;
...
import com.example.bankingapp1.DB.UserContract.UserEntry;
...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + " values(7860,'Shagufta Hundekari', 'shagufta@gmail.com','7584','7895641238', 15000)");
        db.execSQL("insert into " + TABLE_NAME + " values(5862,'Amreen Patel', 'amreen@gmail.com','1258','8995641238', 5000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7895,'Arshi Shaikh', 'arshi@gmail.com','8896','7595645896', 1000)");
        db.execSQL("insert into " + TABLE_NAME + " values(1258,'Hiba Sayeed', 'hiba@gmail.com','7752','9995640038', 8000)");
        db.execSQL("insert into " + TABLE_NAME + " values(7410,'Imran Shaikh', 'immu@gmail.com','3669','9095648962', 7500)");
        ...
        db.execSQL("insert into " + TABLE_NAME + " values(4562,'Hasiba Shaikh', 'hasiba@gmail.com','6582','9309565238', 10500)");
        ...
        db.execSQL("insert into " + TABLE_NAME + " values(9512,'Gausiya Khan', 'gausiya@gmail.com','2236','6254642205', 3500)");
